...
class ClickScale extends StatefulWidget {
  final Widget? child;
  final GestureTapCallback? onTap;

  ClickScale({Key? key, this.child, this.onTap});

  @override
  _ClickScaleState createState() => _ClickScaleState();
}

class _ClickScaleState extends State<ClickScale> with SingleTickerProviderStateMixin {
